...
public class UHFWriteFragment extends KeyDwonFragment implements OnClickListener{
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        SpinnerBank_Write = getView().findViewById(R.id.SpinnerBank_Write);
        EtPtr_Write =  getView().findViewById(R.id.EtPtr_Write);
        EtLen_Write =getView().findViewById(R.id.EtLen_Write);
        EtData_Write =getView().findViewById(R.id.EtData_Write);
        EtAccessPwd_Write =getView().findViewById(R.id.EtAccessPwd_Write);
        etLen_filter_wt= getView().findViewById(R.id.etLen_filter_wt);
        BtWrite = getView().findViewById(R.id.BtWrite);

        cb_QT_W=getView().findViewById(R.id.cb_QT_W);
        cb_filter_wt =getView().findViewById(R.id.cb_filter_wt);
        etPtr_filter_wt = getView().findViewById(R.id.etPtr_filter_wt);
        etData_filter_wt =  getView().findViewById(R.id.etData_filter_wt);
        rbEPC_filter_wt =  getView().findViewById(R.id.rbEPC_filter_wt);
        rbTID_filter_wt = getView().findViewById(R.id.rbTID_filter_wt);
        rbUser_filter_wt = getView().findViewById(R.id.rbUser_filter_wt);
    ...
    public void onClick(View view) {
        int i = view.getId();
        if (i == R.id.rbEPC_filter_wt) {
            etPtr_filter_wt.setText("32");

        } else if (i == R.id.rbTID_filter_wt) {
            etPtr_filter_wt.setText("0");

        } else if (i == R.id.rbUser_filter_wt) {
            etPtr_filter_wt.setText("0");

        } else if (i == R.id.BtWrite) {
            write();
