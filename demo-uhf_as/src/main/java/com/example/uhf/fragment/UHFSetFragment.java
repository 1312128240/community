...
public class UHFSetFragment extends KeyDwonFragment implements OnClickListener {
    ...
    public Button btnSetPower;
    public Button btnGetPower;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        btnSetFre = getView().findViewById(R.id.BtSetFre);
        btnGetFre = getView().findViewById(R.id.BtGetFre);
         ll_freHop=getView().findViewById(R.id.ll_freHop);
        btnSetPower=getView().findViewById(R.id.btnSetPower);
        btnGetPower=getView().findViewById(R.id.btnGetPower);
        spPower=getView().findViewById(R.id.spPower);
        et_worktime=getView().findViewById(R.id.et_worktime);
        et_waittime=getView().findViewById(R.id.et_waittime);
        btnWorkWait=getView().findViewById(R.id.btnWorkWait);
        spFreHop=getView().findViewById(R.id.spFreHop);
        btnSetFreHop=getView().findViewById(R.id.btnSetFreHop);
        tv_normal_set=getView().findViewById(R.id.tv_normal_set);
        btnGetWait=getView().findViewById(R.id.btnGetWait);
        btnSetAgreement=getView().findViewById(R.id.btnSetAgreement);
        SpinnerAgreement=getView().findViewById(R.id.SpinnerAgreement);
        btnSetLinkParams=getView().findViewById(R.id.btnSetLinkParams);
        btnGetLinkParams=getView().findViewById(R.id.btnGetLinkParams);
        splinkParams=getView().findViewById(R.id.splinkParams);
        btnSetQTParams=getView().findViewById(R.id.btnSetQTParams);
        btnGetQTParams=getView().findViewById(R.id.btnGetQTParams);
        cbQt=getView().findViewById(R.id.cbQT);
        cbTagFocus=getView().findViewById(R.id.cbTagFocus);
        cbFastID=getView().findViewById(R.id.cbFastID);
        cbEPC_TID=getView().findViewById(R.id.cbEPC_TID);
        rb_America=getView().findViewById(R.id.rb_America);
        rb_Others=getView().findViewById(R.id.rb_Others);
        SpSession=getView().findViewById(R.id.spsession);
        SpInv=getView().findViewById(R.id.spinv);
        btnGetSession=getView().findViewById(R.id.btnGetSession);
        btnSetSession=getView().findViewById(R.id.btnSetSession);
        SpSession=getView().findViewById(R.id.spsession);
        SpInv=getView().findViewById(R.id.spinv);
        spMode =getView().findViewById(R.id.SpinnerMode);
...
//            mContext.playSound(2);
    ...
    public void onClick(View v) {
        int i = v.getId();//设置频点
        if (i == R.id.btnSetFreHop) {//			showFrequencyDialog();
        ...
        } else if (i == R.id.btnGetWait) {
            getPwm();

        } else if (i == R.id.btnSetAgreement) {
...
//                    mContext.playSound(2);
        ...
        } else if (i == R.id.btnSetLinkParams) {
...
//                    mContext.playSound(2);
        ...
        } else if (i == R.id.btnGetLinkParams) {
            getLinkParams();

        } else if (i == R.id.btnSetSession) {// //设置SESSION只针对盘点EPC有效，对返回EPC+TID,EPC+TID+USER无效
