...
public class UHFReadFragment extends KeyDwonFragment implements OnClickListener{
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        SpinnerBank_Read = getView().findViewById(R.id.SpinnerBank_Read);
        EtPtr_Read = getView().findViewById(R.id.EtPtr_Read);
        EtLen_Read =  getView().findViewById(R.id.EtLen_Read);
        EtAccessPwd_Read =getView().findViewById(R.id.EtAccessPwd_Read);
        SpinnerOption_Read = getView().findViewById(R.id.SpinnerOption_Read);
        EtPtr2_Read =  getView().findViewById(R.id.EtPtr2_Read);
        EtLen2_Read = getView().findViewById(R.id.EtLen2_Read);
        EtData_Read = getView().findViewById(R.id.EtData_Read);
        etLen_filter=getView().findViewById(R.id.etLen_filter);
        BtRead = getView().findViewById(R.id.BtRead);

        cb_QT_R =getView().findViewById(R.id.cb_QT_R);
    ...
    public void onClick(View view) {
        ...
        } else if (i == R.id.rbTID_filter) {
            if (rbTID_filter.isChecked()) {
                etPtr_filter.setText("0");
            }

        } else if (i == R.id.rbUser_filter) {
            if (rbUser_filter.isChecked()) {
                etPtr_filter.setText("0");
            }

        } else if (i == R.id.BtRead) {
            read();
